...
GITHUB_RESPONSE=`curl -H "Authorization: token $GITHUB_TOKEN" -d "{\"tag_name\": \"$PACKAGE_VERSION\", \"name\": \"Insight Tester\"}" "https://api.github.com/repos/$OWNER/$PACKAGE/releases"`
