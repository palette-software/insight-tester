...
//type ProcessRowValuesFunc func(columns []string, values []reflect.Value) error
//
//func (dbc *DbConnector) QueryValues(sql_statement string, handler ProcessRowValuesFunc) error {
//	db, err := dbc.getConnection()
//	if err != nil {
//		return err
//	}
...
//	}
//
//	//var values = make([]reflect.Value, column_count)
//	////for i, _ := range values {
//	////	values[i] = *new(reflect.Value)
//	////}
//	//interfaceValues := make([]interface{}, column_count)
//	//for i, _ := range interfaceValues {
...
//		rowCount++
//
//		reflectValues := make([]reflect.Value, column_count)
//		for i, _ := range reflectValues {
//			reflectValues[i] = reflect.Indirect(reflect.ValueOf(values[i]))
//		}
//		handler(columns, reflectValues)
//	}
//
//	log.Debugf("SQL STATEMENT: %v", sql_statement)
//	log.Debugf("OK: [HOST:%v] [COUNT:%v] [DURATION:%v]", dbc.Host, rowCount, time.Since(start))
